# ESPHome RF Bridge v1.3.14

ESPHome external component for an ESP32 + CC1101 Outprize RF bridge.

v1.3.14 is a diagnostics-only release. It stores the raw edge timings from the OEM capture that produced `OUTPRIZE_LEARNED` and adds a helper to compare that learned OEM pulse train against the ESP transmitter's generated pulse train.
...
1. Flash v1.3.14 with diagnostic logging enabled.
